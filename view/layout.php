...
<head>
    ...
    <title>Bienvenu sur le blog test !</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="?op=null">Blog    </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="?op=null">Articles</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?op=add">Ajouter</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?op=admin">Admin</a>
                    </li>
                </ul>
                <form class="d-flex">
